 ...
 */
package com.binomed.cst.client.ui.coverflow;
...
public class ImageLoader {
	...
	private native ImageElement prepareImage(String url)/*-{
		...
		img.__isLoaded = true;       
		__this.@com.binomed.cst.client.ui.coverflow.ImageLoader::incrementLoadedImages()();
		img.onload = null;

		// we call this function each time onload fires
		// It will see if we are ready to invoke the callback
		__this.@com.binomed.cst.client.ui.coverflow.ImageLoader::dispatchIfComplete()();   
		} else {

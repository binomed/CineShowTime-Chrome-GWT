...
public interface CstResource extends ClientBundle {
	...
	// Images
	@Source("com/binomed/cst/client/resources/images/star.png")
	// @ImageOptions(repeatStyle = RepeatStyle.Horizontal, height = 16, width = 16)
	ImageResource star();

	@Source("com/binomed/cst/client/resources/images/gps.png")
	ImageResource gps();

	// CSS
	@Source("com/binomed/cst/client/resources/css/CstStyle.css")
